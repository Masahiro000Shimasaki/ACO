...
{
  BaseScene::Draw();
  DrawString(50, 200, "描画したい内容を記述してください", GetColor(0, 0, 0));
  DrawString(80, SEL1_Y, "Enterキーを押すと画面が変わります", GetColor(0, 0, 0));
  DrawString(80, SEL2_Y, "Enterキーを押すと画面が変わります", GetColor(0, 0, 0));
  DrawString(80, SEL3_Y, "Enterキーを押すと画面が変わります", GetColor(0, 0, 0));
  int y = 0;
  switch(NowSelect)
  {
    case 0:
  ...
  DrawString(60, y, "アイコン？を表示するための記述", GetColor(255, 0, 0));
}
